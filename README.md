...
> the Store API has been integrated into the Shopware core. It will become standard feature since v6.8.0.0, but you can already
> use it starting with v6.7.6.0 by enabling the `CACHE_REWORK` feature flag.
